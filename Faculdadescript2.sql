...
CREATE TABLE IF NOT EXISTS `Faculdadepovoamento`.`Turmas` (
  ...
  `Turmascol` VARCHAR(45) NULL DEFAULT 0 COMMENT '')
ENGINE = InnoDB;
...
START TRANSACTION;
USE `Faculdadepovoamento`;
INSERT INTO `Faculdadepovoamento`.`Turmas` (`CodTurma`, `Alunos_Matricula`, `Professores_SIAPE`, `Disciplinas_CodDisciplina`, `Qtd`, `Local`, `Início`, `Fim`, `Dia`, `Semestre`, `Nota`, `Turmascol`) VALUES (1, 336099, 1548722, 'SBL001', 55, 'Sala 1', '08', '10', 'Segunda', 2015.2, 9.5, NULL);
INSERT INTO `Faculdadepovoamento`.`Turmas` (`CodTurma`, `Alunos_Matricula`, `Professores_SIAPE`, `Disciplinas_CodDisciplina`, `Qtd`, `Local`, `Início`, `Fim`, `Dia`, `Semestre`, `Nota`, `Turmascol`) VALUES (2, 321193, 0267703, 'EEL003', 55, 'Sala 3', '10', '12', 'Terça', NULL, NULL, NULL);
INSERT INTO `Faculdadepovoamento`.`Turmas` (`CodTurma`, `Alunos_Matricula`, `Professores_SIAPE`, `Disciplinas_CodDisciplina`, `Qtd`, `Local`, `Início`, `Fim`, `Dia`, `Semestre`, `Nota`, `Turmascol`) VALUES (3, 321194, 1572044, 'SBL004', 55, 'Sala 2', '10', '12', 'Quarta', NULL, NULL, NULL);
INSERT INTO `Faculdadepovoamento`.`Turmas` (`CodTurma`, `Alunos_Matricula`, `Professores_SIAPE`, `Disciplinas_CodDisciplina`, `Qtd`, `Local`, `Início`, `Fim`, `Dia`, `Semestre`, `Nota`, `Turmascol`) VALUES (3, 345447, 1645759, 'ECO002', 60, 'lab 1', '10', '12', 'Segunda', NULL, NULL, NULL);
INSERT INTO `Faculdadepovoamento`.`Turmas` (`CodTurma`, `Alunos_Matricula`, `Professores_SIAPE`, `Disciplinas_CodDisciplina`, `Qtd`, `Local`, `Início`, `Fim`, `Dia`, `Semestre`, `Nota`, `Turmascol`) VALUES (4, 305407, 1548722, 'SBL005', 55, 'lab 2', '14', '15', 'Quarta', NULL, NULL, NULL);
INSERT INTO `Faculdadepovoamento`.`Turmas` (`CodTurma`, `Alunos_Matricula`, `Professores_SIAPE`, `Disciplinas_CodDisciplina`, `Qtd`, `Local`, `Início`, `Fim`, `Dia`, `Semestre`, `Nota`, `Turmascol`) VALUES (5, 305407, 1131493	, 'EEL044', 40, 'lab 3', '16', '18', 'Sexta', NULL, NULL, NULL);
