...
INSERT INTO `Faculdadepovoamento`.`Turmas` (`CodTurma`, `Alunos_Matricula`, `Professores_SIAPE`, `Disciplinas_CodDisciplina`, `Qtd`, `Local`, `Início`, `Fim`, `Dia`, `Semestre`, `Nota`, `Turmascol`) VALUES (2, 321194, 1572044, 'SBL004', 55, 'Sala 2', '10', '12', 'Quarta', NULL, NULL, NULL);
